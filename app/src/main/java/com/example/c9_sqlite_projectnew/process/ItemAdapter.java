...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        holder.tvName.setText("Tên: " + item.getName());
        holder.tvStatus.setText("Tình trạng: " + item.getStatus());
        holder.tvDetail.setText("Nội dung: "+item.getDetail());
        holder.tvDate.setText("Ngày hoàn thành: " + item.getDate());
